...
//添加术语
export const addTerm = p => post(url + '/check/terminology', p);
//忽略
export const neglect = p => post(url + '/info/ignore', p);
//收藏
export const favorite = p => post(url + '/info/favorite', p);
//用户反馈
export const feedBack = p => post(url + '/feedback/add', p);
//文件上传
export const upFile = p => post(url + '/upload', p);
//获取研究员
export const getPersonnel = p => get(url + '/check/Researcher', p);
//LDO图表  -  质押资产总价值
export const LdoTotal = p => get(url + '/charts/ldo/getPledgedUSD', p);
//LDO图表  -  质押占比
export const LdoPre = p => get(url + '/charts/ldo/getPledgedRatio', p);
//LDO图表  -  质押总价值
export const LdoAmount = p => get(url + '/charts/ldo/getPledgedCoin', p);
//LDO图表  -  质押人数
export const LdoProple = p => get(url + '/charts/ldo/getPledgedNumber', p);
//操作统计
export const setPoint = p => get(url + '/buriedPoint', p);
//HNT图表
export const HntMsg = p => get(url + '/charts/hnt/getHotspots', p);
//Torn图表
export const TornMsg = p => get(url + '/charts/torn/getTornChart', p);
//获取海报
export const getPoster = p => get(url + '/poster/Poster', p);
//EDEN图表 - 算力占比
export const EdenPower = p => get(url + '/charts/eden/getEdenFountain', p);
//EDEN图表 - Slot拍卖情况
export const EdenSlot = p => get(url + '/charts/eden/getEdenSlot', p);
//EDEN图表 - 质押EDEN数和质押人数
export const EdenPledge = p => get(url + '/charts/eden/getEdenStaked', p);
//EDEN图表 - 质押情况
export const EdenPledgeTable = p => get(url + '/charts/eden/getEdenPledge', p);
//EDEN图表 - 代币质押情况
export const EdenPledgeTwo = p => get(url + '/charts/eden/getEdenDistribution', p);
//Float图表 - Float价格
export const FloatPrice = p => get(url + '/charts/float/getFloatPrice', p);
//Float图表 - Float TVL
export const FloatTVL = p => get(url + '/charts/float/getFloatTvl', p);
//Float图表 - Float供应量
export const FloatSupply = p => get(url + '/charts/float/getFloatSuppty', p);
//Float图表 - Float持有地址数
export const FloatAddress = p => get(url + '/charts/float/getFloatHolder', p);
//Float图表 - Bank持有地址数
export const FloatBank = p => get(url + '/charts/float/getFloatBankHolder', p);
//消息通知
export const NotificationManage = p => get(url + '/user/RemindConfig', p);
//消息通知 - 变更
export const ChangeNotification = p => post(url + '/user/setRemindConfig', p);
//NFT - 抽奖状态
export const DrawnStatus = p => get(url + '/nft/getNFTInfo', p);
//NFT - 设置抽奖状态
export const SetDrawnStatus = p => post(url + '/nft/alertNFT', p);
//NFT - 抽取NFT
export const LotterNFT = p => post(url + '/nft/lotteryNFT', p);
//NFT - 获取铸币信息
export const BulidMsg = p => post(url + '/nft/getMintNFT', p);
//NFT - 领取NFT
export const ReceiveNFT = p => post(url + '/nft/receiveNFT', p);
//AAVE图表 - Aave资金锁仓规模
export const AaveTVL = p => get(url + '/charts/aave/getAaveTVL', p);
//AAVE图表 - Aave资金池内信息
export const AavePool = p => get(url + '/charts/aave/getAaveAsset', p);
//AAVE图表 - Aave v2活跃用户数
export const AaveActive = p => get(url + '/charts/aave/getActiverUser', p);
//项目入口统计
export const SetProjectInto = p => get(url + '/buriedEnter', p);
//Index图表 - 指数代币供应量
export const IndexSupply = p => get(url + '/charts/index/getCoinSupply', p);
//Index图表 - FLI交易量
export const IndexFLI = p => get(url + '/charts/index/getFliTrade', p);
//Index图表 - DPI交易量
export const IndexDPI = p => get(url + '/charts/index/getDpiTrade', p);
//Lmmutable图表 - Lmmutable X TVL
export const LmmuTVL = p => get(url + '/charts/imx/getImxTvl', p);
//Lmmutable图表 - Lmmutable X 生态
export const LmmuEco = p => get(url + '/charts/imx/getImxMarket', p);
//MAGIC图表
export const Maglc = p => get(url + '/charts/maglc/getMaglcInfo', p);
//Convex图表
export const Convex = p => get(url + '/charts/cvx/getCvxInfo', p);
//Hop Protocol - ETH
export const HopEth = p => get(url + '/charts/hop/getEthTVL', p);
//Hop Protocol - Users Active
export const HopActive = p => get(url + '/charts/hop/getHopUser', p);
//Hop Protocol - TVL
export const HopTVL = p => get(url + '/charts/hop/getHopTVL',p);
//独立重点情报统计
export const StaImportant = p => get(url + '/focusBuried', p);
//FEI - PCV中代币资产组合
export const FeiCom = p => get(url + '/charts/fei/getFeiPVC', p);
//FEI - FEI的持有分布
export const FeiDis = p => get(url + '/charts/fei/getFeiCirculating', p);
//FEI - PCV中代币资产占比
export const FeiPre = p => get(url + '/charts/fei/getFeiCoreAsset', p);
//FEI - 协议持有的FEI分布情况
export const FeiPro = p => get(url + '/charts/fei/getFeiPlatform', p);
//FEI - TRIBE的交易次数
export const FeiTrade = p => get(url + '/charts/fei/getFeiTransactions', p);
//Gala - Gala Games创始人在线节点数
export const GalaOnline = p => get(url + '/charts/gala/onlineNodes', p);
//Gala - Gala Games生态内游戏合作情况
export const GalaTeam = p => get(url + '/charts/gala/getGames', p);
//Gear - Charts
export const GearCharts = p => get(url + '/charts/gear/getGearInfo', p);
